...
void OV2640_set_JPEG_size(byte address, uint8_t size);
void OV5642_set_JPEG_size(byte address, uint8_t size);
void OV5640_set_JPEG_size(byte address, uint8_t size);
...
int  wrSensorRegs8_8(byte address, const struct sensor_reg*);
